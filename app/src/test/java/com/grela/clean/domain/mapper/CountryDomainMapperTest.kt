package com.grela.clean.domain.mapper
...
class CountryDomainMapperTest : BaseUnitTest() {

    @Test
    fun `given country domain entity, when mapped to country domain entity, then it is correct type`() {
